...
class ObservabilityRetryMetricsWireMockTest {
    ...
    void setUp() throws IOException {
        ...
        WireMock.stubFor(
                WireMock.post("/20231130/actions/chat")
                        ...
                        .withRequestBody(
                                WireMock.matching(
                                        "(?s).*Answer the following question clearly and concisely:.*"))
        ...
        WireMock.stubFor(
                WireMock.post("/20231130/actions/chat")
                        .atPriority(1)
                        .withRequestBody(
                                WireMock.matching("(?s).*Evaluate whether the following answer.*"))
                        .willReturn(
    ...
    void retryCounterIncrementsAndRecoverFallbackReturned() {
        ...
        ResponseEntity<String> metricJson =
                rest.getForEntity(
                        "/actuator/metrics/app_llm_retries_total?tag=reason:AnswerNotRelevantException",
                        String.class);
