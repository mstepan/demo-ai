...
- Metrics appear only after traffic has been served. Generate requests (e.g., POST /ask and POST /ask/stream) before
  scraping.
...
The docker image build using standard cloud-native buildpack:
